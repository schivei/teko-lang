...
| **→ NEXT** | 🗣️ **DEFINE INTERFACES FIRST (user 2026-06-29), BEFORE the class/unit question (W10b.0.B).** Interfaces (the contract abstraction) shape what the OOP unit must satisfy, so they are defined ahead of W10b.0.B. (This re-orders the provisional waves — B4 moves to the front.) | decision | gate | interface design locked |
