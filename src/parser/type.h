...
struct tk_type_expr {
    enum { TK_TEXPR_NAMED, TK_TEXPR_SLICE, TK_TEXPR_UNION, TK_TEXPR_OPTIONAL, TK_TEXPR_FUNC } tag;
    union {
        ...
        struct { tk_type_expr *params; size_t nparams; tk_type_expr *ret; } func;   // (W10a) FunctionType `(A, B) -> R` — closure/function value type; checker maps to Func
    } as;
};
