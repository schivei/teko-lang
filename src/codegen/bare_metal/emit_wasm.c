...
int teko_metal_emit_dom_glue(MetalContext* ctx, const char* path) {
    ...
    fprintf(g, "// AUTO-GENERATED by the Teko WASM backend (Browser FFI MVP-2). Do not edit.\n");
    ...
    fprintf(g, "// WebAssembly.Memory (available only after instantiation).\n");
    fprintf(g, "export function makeTekoDomImports(getMemory) {\n");
