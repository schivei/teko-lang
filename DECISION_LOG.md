...
### D68 · RATCHET DE MEMÓRIA — o pico nunca cresce durante a campanha (owner 2026-08-24) ✅ RATIFICADA
Durante o processo de ajuste de memória (Eixo A/B/C, jardinagem, DPS), o pico de RSS **NUNCA pode crescer**. Toda mudança tem que **baixar ou manter**; qualquer aumento = regressão, reverter/corrigir ANTES de landar. Gravado em `CLAUDE.md` (bloco do guard de memória).
