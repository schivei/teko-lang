...
From D29/D31 empirical benchmarking (see `docs/design/vm-retirement.md` for retirement context): **compiler's arena budget is ~366 MB (codegen + front-end), leak-to-root batch-safe with right-sizing (free-list + first-rung tuning + free-old-on-grow).**
